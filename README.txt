...
This application allows users to manage and convert purchases to different currencies based on Treasury Reporting Rates of Exchange.
...
Convert Purchase to Another Currency:

3. On the Purchase list screen, select the “Convert” option for the desired purchase.
